...
def Subplot3d():
    ...
    # from matplotlib_folder.ticker import LinearLocator, FixedLocator, FormatStrFormatter
    import matplotlib.pyplot as plt
    import numpy as np
...
def draw_figure(canvas, figure, loc=(0, 0)):
    """ Draw a matplotlib_folder figure onto a Tk canvas
    loc: location of top-left corner of figure on canvas in pixels.
    Inspired by matplotlib_folder source: lib/matplotlib_folder/backends/backend_tkagg.py
    """
