...
class Camera:
    ...
    def view_matrix(self):
        print(f'{self.pos=}')
        return dpg.create_fps_matrix([self.pos[_] for _ in range(4)], self.pitch, self.yaw)
    ...
    def submit(self, layer=None):
        ...
        with dpg.draw_node(tag=self.node):
            self.triangles.append(
                dpg.draw_triangle(self.verticies[1], self.verticies[2], self.verticies[0], color=self.outline_color,
                                  fill=self.colors[0], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[1], self.verticies[3], self.verticies[2], color=self.outline_color,
                                  fill=self.colors[1], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[7], self.verticies[5], self.verticies[4], color=self.outline_color,
                                  fill=self.colors[2], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[6], self.verticies[7], self.verticies[4], color=self.outline_color,
                                  fill=self.colors[3], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[9], self.verticies[10], self.verticies[8], color=self.outline_color,
                                  fill=self.colors[4], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[9], self.verticies[11], self.verticies[10], color=self.outline_color,
                                  fill=self.colors[5], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[15], self.verticies[13], self.verticies[12], color=self.outline_color,
                                  fill=self.colors[6], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[14], self.verticies[15], self.verticies[12], color=self.outline_color,
                                  fill=self.colors[7], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[18], self.verticies[17], self.verticies[16], color=self.outline_color,
                                  fill=self.colors[8], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[19], self.verticies[17], self.verticies[18], color=self.outline_color,
                                  fill=self.colors[9], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[21], self.verticies[23], self.verticies[20], color=self.outline_color,
                                  fill=self.colors[10], thickness=1))
            self.triangles.append(
                dpg.draw_triangle(self.verticies[23], self.verticies[22], self.verticies[20], color=self.outline_color,
                                  fill=self.colors[11], thickness=1))
    ...
    def show_controls(self):
        ...
        with dpg.window(label="Controls", width=500, height=500):
            ...
            dpg.add_radio_button(["mvCullMode_None", "mvCullMode_Back", "mvCullMode_Front"],
                                 default_value="mvCullMode_Back", label="cull_mode",
