                ...
                with dpg.popup(dpg.last_item(), modal=True, mousebutton=dpg.mvMouseButton_Left, tag="__demo_popup2"):
                    ...
                    with dpg.group(horizontal=True):
                        dpg.add_button(label="OK", width=75,
                                       callback=lambda: dpg.configure_item("__demo_popup2", show=False))
        ...
        with dpg.collapsing_header(label="Drawing API"):
            ...
            with dpg.drawlist(width=300, height=200):
                ...
                for i in range(2):
                    ...
                    dpg.draw_rectangle([draw_x, draw_y], [draw_size + draw_x, draw_size + draw_y], thickness=_draw_t,
                                       color=draw_color)
                    draw_x = draw_x + draw_spacing + draw_size
                ...
                draw_x = draw_x + draw_spacing + draw_size
                dpg.draw_rectangle([draw_x, draw_y], [draw_size + draw_x, draw_size + draw_y], rounding=draw_rounding,
                                   thickness=_draw_t, color=draw_color, fill=draw_color)
                draw_x = draw_x + draw_spacing + draw_size
                dpg.draw_triangle([draw_x + draw_size * 0.5, draw_y], [draw_x + draw_size, draw_y + draw_size - 0.5],
                                  [draw_x, draw_y + draw_size - 0.5], thickness=_draw_t, color=draw_color,
                                  fill=draw_color)
                draw_x = draw_x + draw_spacing + draw_size
